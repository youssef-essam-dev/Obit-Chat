    ...
    const ChatBox = () => {
        ...
        useEffect(() => {
            console.log("Component mounted, status:", messagesStatus);
            if (messagesStatus && friendsStatus === 'idle') {
    ...
    */
        ...
        */
        ...
        // Conditionally display full or filtered list
            ...
            <div className="chat-container"  >
                ...
                <div className="chat-header">
                    ...
                    <div className="chat-header-messages">
                        ...
                        <div className='headr-friendname'><img src="/Images/noto--person.svg" className="header-icon" />Friend Name</div>
